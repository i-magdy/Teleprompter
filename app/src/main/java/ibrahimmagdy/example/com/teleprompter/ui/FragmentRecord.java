...
public class FragmentRecord extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
       ...
       // mButtonVideo = view.findViewById(R.id.record_button);
        ...
        mTextView = view.findViewById(R.id.textview_preview);
    ...
    public static class ConfirmationDialog extends android.support.v4.app.DialogFragment {
        ...
        @Override
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            final android.app.Activity parent = getActivity();
            return new AlertDialog.Builder(getActivity())
                    .setMessage(R.string.permission_request)
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(parent, VIDEO_PERMISSIONS,
